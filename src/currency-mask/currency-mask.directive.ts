import { Directive, ElementRef, forwardRef, HostListener, KeyValueDiffer, KeyValueDiffers, Input, Optional, Inject } from '@angular/core';
...
export class CurrencyMaskDirective implements ControlValueAccessor, Validator {
    ...
    constructor(@Optional() @Inject(CURRENCY_MASK_CONFIG) private currencyMaskConfig: CurrencyMaskConfig,
        ...
        if (this.currencyMaskConfig) {
            this.optionsTemplate = this.currencyMaskConfig;
        }
