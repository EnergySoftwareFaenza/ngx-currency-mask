...
export class InputHandler {
    ...
    handleClick(event: any, chromeAndroid: boolean): void {
        const inputSelection = this.inputService.inputSelection;
        const selectionRangeLength = Math.abs(inputSelection.selectionEnd - inputSelection.selectionStart);
    ...
    handleInput(event: any): void {
        ...
        if ((rawValueSelectionEnd != rawValueWithoutSuffixEndPosition || Math.abs(rawValueLength - storedRawValueLength) != 1) &&
